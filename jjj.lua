...
local tab2 = DrRayLibrary.newTab("Tab 1", "ImageIdHere")
tab2.newLabel("Hello, this is Tab 1.")
local tab3 = DrRayLibrary.newTab("Tab 1", "ImageIdHere")
tab3.newLabel("Hello, this is Tab 1.")
local tab4 = DrRayLibrary.newTab("Tab 1", "ImageIdHere")
tab4.newLabel("Hello, this is Tab 1.")
local tab5 = DrRayLibrary.newTab("Tab 1", "ImageIdHere")
tab5.newLabel("Hello, this is Tab 1.")
local tab6 = DrRayLibrary.newTab("Tab 1", "ImageIdHere")
tab6.newLabel("Hello, this is Tab 1.")
local tab7 = DrRayLibrary.newTab("Tab 1", "ImageIdHere")
tab7.newLabel("Hello, this is Tab 1.")
