...
local b = {
    ["_TTJY ASSET"] = _U[35]("ScreenGui"),
    ["_TTJY HUB"] = _U[35]("Frame"),
    ["_UIStroke"] = _U[35]("UIStroke"),
    ["_UICorner"] = _U[35]("UICorner"),
    ["_TextButton"] = _U[35]("TextButton"),
    ["_UIStroke1"] = _U[35]("UIStroke")
}
...
local screenGui = _U[35]("ScreenGui")
screenGui.Name = "TTJY HUB"
screenGui.Parent = __VE["CG"]

local textButton = _U[35]("TextButton")
...
local screenGui2 = _U[35]("ScreenGui")
...
function tp(x, y, z, speed)
	pcall(function()
		...
		local velocity = _U[35]("BodyVelocity")
...
FLysss:OnChanged(function()
	if Options.FLysss.Value then
		...
		function FLY()
			local BG = _U[35]('BodyGyro', T)
			local BV = _U[35]('BodyVelocity', T)
			BG.P = 9e4
