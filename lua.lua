        ...
        if game:GetService("Players").LocalPlayer.PlayerGui.Main.ChooseTeam.Visible == true then
            if __Team.Select == "Marines" then
                for i,v in __U[7]({"MouseButton1Click", "MouseButton1Down", "Activated"}) do
                    for i,v in __U[7](getconnections(game:GetService("Players").LocalPlayer.PlayerGui.Main.ChooseTeam.Container.Marines.Frame.TextButton[v])) do
                        v.Function()
                    end
                end
            else
                for i,v in __U[7]({"MouseButton1Click", "MouseButton1Down", "Activated"}) do
                    for i,v in __U[7](getconnections(game:GetService("Players").LocalPlayer.PlayerGui.Main.ChooseTeam.Container.Pirates.Frame.TextButton[v])) do
                        v.Function()
                    end
                end
            end
...
repeat
    ...
    print("Loaded Ui")
    wait(10)
until Fluent ~= nil and SaveManager ~= nil and InterfaceManager ~= nil
]]
Fluent = loadstring(game:HttpGet("https://github.com/dawid-scripts/Fluent/releases/latest/download/main.lua"))()
SaveManager = loadstring(game:HttpGet("https://raw.githubusercontent.com/dawid-scripts/Fluent/master/Addons/SaveManager.lua"))()
InterfaceManager = loadstring(game:HttpGet("https://raw.githubusercontent.com/dawid-scripts/Fluent/master/Addons/InterfaceManager.lua"))()
--[[
local __x__ , __y__ = xpcall(function(abc,xyz)
...
local Setting , fileContent, serializedSetting
	...
	if Old_World then
		...
		elseif Setting.SelectBoss == "Fishman Lord" then
			...
			if (CFrameQBoss.Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude > 3000 then
				game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("requestEntrance",__U[57](61163.8515625, 11.6796875, 1819.7841796875))
			end
		elseif Setting.SelectBoss == "Wysper" then
			...
			if (CFrameQBoss.Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude > 3000 then
				game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("requestEntrance",__U[57](-4607.82275, 872.54248, -1667.55688))
			end
    ...
    elseif Third_World then
        ...
        elseif SelectTpSpot == "Port Town" then
            if InstanceTp then
                ...
                CFrameTargetTp = CFrame.new(-435.68109130859, 189.69866943359, 5551.0756835938)
                if (__U[57](-435.68109130859, 189.69866943359, 5551.0756835938) - player.Character.HumanoidRootPart.Position).Magnitude > 9000 then
                    if Setting.UnlockPortal then
        ...
        elseif SelectTpSpot == "Great Tree" then
            if InstanceTp then
                ...
                CFrameTargetTp = CFrame.new(2198.0063476563, 128.71075439453, -7109.5043945313)
                if (__U[57](2198.0063476563, 128.71075439453, -7109.5043945313) - player.Character.HumanoidRootPart.Position).Magnitude > 11500 then
                    if Setting.UnlockPortal then
                        CommF:InvokeServer("requestEntrance", __U[57](5748.7587890625, 610.44982910156, -267.81704711914))
                        task.wait(0.5)
                    end
        ...
        elseif SelectTpSpot == "Haunted Castle" then
            if InstanceTp then
                ...
                CFrameTargetTp = CFrame.new(-9709.30762, 204.695892, 6044.04688)
                if Setting.UnlockPortal then
                    if (__U[57](2198.0063476563, 128.71075439453, -7109.5043945313) - player.Character.HumanoidRootPart.Position).Magnitude > 9000 then
                        CommF:InvokeServer("requestEntrance",__U[57](-5072.08984375, 314.5412902832, -3151.1098632812))
                        task.wait(0.5)
                    end
                end
        ...
        elseif SelectTpSpot == "Ice Cream Island" then
            if InstanceTp then
                ...
                CFrameTargetTp = CFrame.new(-821.35913085938, 65.845329284668, -10965.2578125)
                if Setting.UnlockPortal then
                    if (__U[57](-821.35913085938, 65.845329284668, -10965.2578125) - player.Character.HumanoidRootPart.Position).Magnitude > 10000 then
                        CommF:InvokeServer("requestEntrance",__U[57](-5072.08984375, 314.5412902832, -3151.1098632812))
                        task.wait(0.5)
                    end
                end
        ...
        elseif SelectTpSpot == "Peanut Island" then
            if InstanceTp then
                ...
                CFrameTargetTp = CFrame.new(-2104.453125, 38.129974365234, -10194.0078125)
                if Setting.UnlockPortal then
                    if (__U[57](-2104.453125, 38.129974365234, -10194.0078125) - player.Character.HumanoidRootPart.Position).Magnitude > 10000 then
                        CommF:InvokeServer("requestEntrance",__U[57](-5072.08984375, 314.5412902832, -3151.1098632812))
                        task.wait(0.5)
                    end
                end
        ...
        elseif SelectTpSpot == "Peanut Island" then
            if InstanceTp then
                ...
                CFrameTargetTp = CFrame.new(-2017.4874267578125, 36.85276412963867, -12027.53515625)
                if Setting.UnlockPortal then
                    if (__U[57](-2017.4874267578125, 36.85276412963867, -12027.53515625) - player.Character.HumanoidRootPart.Position).Magnitude > 10500 then
                        CommF:InvokeServer("requestEntrance",__U[57](-5072.08984375, 314.5412902832, -3151.1098632812))
                        task.wait(0.5)
                    end
                end
...
local function tpwithnewtpbyme(a,b,c,speedoftpNTP)
    ...
    local steps = __U(distance / speedoftpNTP) 
    for i = 1, steps do
...
local function AutoGetShip()
    if not game.Players.LocalPlayer.Character.Humanoid.Sit and not Setting.WaitBRUH then
        ...
        task.wait()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyBoat", __U[32](Setting.SelectShipISeaEvent))
        task.wait(0.675)
        for _, v in __U[7](workspace.Boats:GetChildren()) do
...
function UnEquipMelee()
    for i,v in __U[7](game.Players.LocalPlayer.Backpack:GetChildren()) do
		if v:IsA("Tool") then
...
local function teleportToNearestChest()
    ...
    if Setting.AutoNormalChest and not Setting.AutoDetailChest then
        for _, v in __U[7](workspace:GetChildren()) do
        ...
        if (Setting.AutoTwinHooks or Setting.AutoTwinHooksHop) and Setting.StackableSetting and Third_World then
            pcall(function()
                if workspace.Enemies:FindFirstChild("Captain Elephant") and Setting.StackableSetting then
                    for _,v in __U[7](workspace.Enemies:GetChildren()) do
    ...
    coroutine.wrap(function()
        ...
        while task.wait() do
            if BringMob and not Setting.AutoFarmAura then
                pcall(function()
                    for _, v in __U[7](workspace.Enemies:GetChildren()) do
                        if v and v.Name == __U[32](NameMon) and v:FindFirstChild("Humanoid") and v.Humanoid.Health > 0 and (v:FindFirstChild("HumanoidRootPart").Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude < 200 then
                            FirstMob = v
                    
                            for _, otherMob in __U[7](workspace.Enemies:GetChildren()) do
                                if otherMob and otherMob.Name == __U[32](NameMon) and otherMob:FindFirstChild("Humanoid") and otherMob.Humanoid.Health > 0 and FirstMob and FirstMob:FindFirstChild("HumanoidRootPart") and (FirstMob:FindFirstChild("HumanoidRootPart").Position - otherMob:FindFirstChild("HumanoidRootPart").Position).Magnitude < tonumber(Setting.BringMobDistance) then
        ...
        while task.wait() do
            if Setting.AutoFarmLevel and not Setting.AutoSea2 then
                pcall(function()
                    ...
                    repeat
                        for _,v in __U[7](workspace.Enemies:GetChildren()) do
                            if v and v.Name == __U[32](NameMon) and (CFrameMon.Position - player.Character.HumanoidRootPart.Position).Magnitude < 3000 then
		...
		while task.wait() do
			if Setting.AutoFarmSelectBoss and not Setting.AutoFarmAllBoss then
				...
				if Setting.CustomQuest then
					if Setting.SelectBoss == "The Saw" or Setting.SelectBoss == "Greybeard" or Setting.SelectBoss == "Saber Expert" then
						if workspace.Enemies:FindFirstChild(__U[32](Setting.SelectBoss)) then
							tpwithnewtpbyme2(CFrameBoss, tonumber(Setting.TeleportSpeedAutoFarm))
							task.wait()
							for _, v in __U[7](workspace.Enemies:GetChildren()) do
								if v and v.Name == __U[32](NameBoss) then
							...
							task.wait(0.675)
						elseif ReplicatedStorage:FindFirstChild(__U[32](Setting.SelectBoss)) then
							tpwithnewtpbyme2(CFrameBoss, tonumber(Setting.TeleportSpeedAutoFarm))
							task.wait()
						end
					else
			...
			elseif Setting.AutoFarmAllBoss and not Setting.AutoFarmSelectBoss then
				if Old_World then
					if Setting.CustomQuest then
						for _, v in __U[7](workspace.Enemies:GetChildren()) do
							if v and table.find(AllBossNameSea1, __U[32](v.Name)) then
						...
						for _, v in __U[7](ReplicatedStorage:GetChildren()) do
							if v and table.find(AllBossNameSea1, __U[32](v.Name)) then
								...
								task.wait(0.675)
                                tpwithnewtpbyme2(CFrameBoss, tonumber(Setting.TeleportSpeedAutoFarm))
							elseif v and not table.find(AllBossNameSea1, __U[32](v.Name)) then
								for _, v in __U[7](workspace.Enemies:GetChildren()) do
									if v and table.find(AllBossNameSea1, __U[32](v.Name)) then
										FindTargetBoss(__U[32](v.Name))
										task.wait(0.675)
        ...
        if Setting.AutoBone then
            pcall(function()
                ...
                if (game:GetService("Workspace").Enemies:FindFirstChild("Reborn Skeleton") or game:GetService("Workspace").Enemies:FindFirstChild("Living Zombie") or game:GetService("Workspace").Enemies:FindFirstChild("Demonic Soul") or game:GetService("Workspace").Enemies:FindFirstChild("Posessed Mummy")) and Setting.AutoBone then
                    ...
                    for i, v in __U[7](game:GetService("ReplicatedStorage"):GetChildren()) do 
                    ...
                    pcall(function()
                        ...
                        elseif not game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Flower 3") and not game:GetService("Players").LocalPlayer.Character:FindFirstChild("Flower 3") then
                            if game:GetService("Workspace").Enemies:FindFirstChild("Zombie") then
                                for _, v in __U[7](game:GetService("Workspace").Enemies:GetChildren()) do
    ...
    while task.wait() do
        if Setting.AutoRaceV4 then
            ...
            elseif game:GetService("Players").LocalPlayer.Data.Race.Value == "Skypiea" and Setting.AutoRaceV4 then
                for i,v in __U[7](game:GetService("Workspace").Map.SkyTrial.Model:GetDescendants()) do
            ...
            elseif game:GetService("Players").LocalPlayer.Data.Race.Value == "Fishman" then
                ...
                task.wait()
                for _, v in __U[7](workspace.SeaBeasts:GetChildren()) do
            ...
            elseif game:GetService("Players").LocalPlayer.Data.Race.Value == "Mink" and Setting.AutoRaceV4 then
                for i,v in __U[7](game:GetService("Workspace"):GetDescendants()) do
								...
								if v:FindFirstChild("Humanoid") and v.Humanoid.Health ~= 0 and Setting.AutoFarmGunMastery and (CFrameMon.Position - player.Character.HumanoidRootPart.Position).Magnitude < 3000 then
									...
									repeat
										...
										if v.Humanoid.Health >= HealthMs then
											...
											tpwithnewtpbyme(MobHumP.X + Setting.AutoFarmPosX, MobHumP.Y + Setting.AutoFarmPosY, MobHumP.Z + Setting.AutoFarmPosZ, tonumber(Setting.TeleportSpeedAutoFarm))
                                            task.wait()
                                            game:GetService("Players").LocalPlayer.Character[__U[32](player.Character:FindFirstChildWhichIsA("Tool"))].RemoteFunctionShoot:InvokeServer(MobHumP)
                                            task.wait()
										end
...
coroutine.wrap(function()
    while task.wait() do
        if Setting.AutoFarmBounty then
            ...
            Setting.UseSkill = true
            for _, v in __U[7](workspace.Characters:GetChildren()) do
                    ...
                    pcall(function()
                        if (not Backpack:FindFirstChild("Special Microchip") or not player.Character:FindFirstChild("Special Microchip")) and (not WorldOrigin.Locations:FindFirstChild("Island 1") or (WorldOrigin.Locations:FindFirstChild("Island 1") and not isTargetNearPlayer(WorldOrigin.Locations:FindFirstChild("Island 1").CFrame, 6700))) then
                            if not WorldOrigin.Locations:FindFirstChild("Island 1") or (WorldOrigin.Locations:FindFirstChild("Island 1") and not isTargetNearPlayer(WorldOrigin.Locations:FindFirstChild("Island 1").CFrame, 6700)) then
                                CommF:InvokeServer("RaidsNpc", "Select", __U[32](Setting.SelectedRaid2))
                            end
                        end
                        task.wait()
                        if not PlayerGui.Main.Timer.Visible and (not WorldOrigin.Locations:FindFirstChild("Island 1") or (WorldOrigin.Locations:FindFirstChild("Island 1") and not isTargetNearPlayer(WorldOrigin.Locations:FindFirstChild("Island 1").CFrame, 6700))) then
...
do
    ...
    Tabs.AutoFarmTab:AddButton({
        ...
        Callback = function()
            WeaponBackpack = {}
            wait()
            for _, item in __U[7](game:GetService("Players").LocalPlayer.Backpack:GetChildren()) do
    ...
    Tabs.MirageARaceT:AddButton({
        ...
        Description = "",
        Callback = function()
            if (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - __U[57](28282.5703125, 14896.8505859375, 105.1042709350586)).Magnitude > 1000 then
                CommF:InvokeServer("requestEntrance",__U[57](28282.5703125, 14896.8505859375, 105.1042709350586))
            elseif (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - __U[57](28282.5703125, 14896.8505859375, 105.1042709350586)).Magnitude < 1000 then
                wait(0.5)
    ...
    Tabs.MirageARaceT:AddButton({
        ...
        Callback = function()
            ...
            elseif (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - __U[57](28282.5703125, 14896.8505859375, 105.1042709350586)).Magnitude < 1000 then
                wait(0.5)
                Teleport(CFrame.new(28575.181640625, 14936.6279296875, 72.31636810302734))
            end
        end
    })
    Tabs.MirageARaceT:AddButton({
    ...
    Tabs.MirageARaceT:AddButton({
        ...
        Description = "",
        Callback = function()
            if (player.Character.HumanoidRootPart.Position - __U[57](28282.5703125, 14896.8505859375, 105.1042709350586)).Magnitude > 1000 then
                CommF:InvokeServer("requestEntrance",__U[57](28282.5703125, 14896.8505859375, 105.1042709350586))
            elseif (player.Character.HumanoidRootPart.Position - __U[57](28282.5703125, 14896.8505859375, 105.1042709350586)).Magnitude < 1000 then
    ...
    SelectIgnoreEvent:OnChanged(function(Value)
        ...
        for Value, State in next, Value do
            __U[30](Setting.IgnoreSeaEventList, Value)
        end
    end)
    ...
    ToggleFly:OnChanged(function()
        ...
        if Setting.ToggleFly then
            ...
            while not cmdlp or not cmdlp.Character or not cmdlp.Character:FindFirstChild('HumanoidRootPart') or not cmdlp.Character:FindFirstChild('Humanoid') or not __VE["GMos"] do
                wait()
            end
            ...
            function FLY()
                local BG = __VE[35]('BodyGyro', T)
                local BV = __VE[35]('BodyVelocity', T)
                BG.P = 9e4
                BG.maxTorque = __U[57](9e9, 9e9, 9e9) -- 9e9 = inf
                BG.cframe = T.CFrame
                ...
                __U[20](function()
                    while FLYING do
                        ...
                        if (CONTROL.L + CONTROL.R) ~= 0 or (CONTROL.F + CONTROL.B) ~= 0 or (CONTROL.Q + CONTROL.E) ~= 0 then
                            BV.velocity = ((__VE["WS"].CurrentCamera.CoordinateFrame.lookVector * (CONTROL.F + CONTROL.B)) + ((__VE["WS"].CurrentCamera.CoordinateFrame * __U[57](CONTROL.L + CONTROL.R, (CONTROL.F + CONTROL.B + CONTROL.Q + CONTROL.E) * 0.2, 0).p) - __VE["WS"].CurrentCamera.CoordinateFrame.p)) * SPEED
                        else
                            BV.velocity = __U[57](0, 0, 0)
                        end
            ...
            __VE["GMos"].KeyDown:connect(function(KEY)
                if KEY:lower() == 'w' then
                    if vfly then
            ...
            __VE["GMos"].KeyUp:connect(function(KEY)
                if KEY:lower() == 'w' then
                    CONTROL.F = 0
                elseif KEY:lower() == 's' then
                    CONTROL.B = 0
    ...
    Tabs.Main:AddButton({
        ...
        Description = "",
        Callback = function()
            __VE["PsG"].Main.InCombat.Visible = not __VE["PsG"].Main.InCombat.Visible
        end
    })
    Tabs.Main:AddButton({
        Title = "SafeZone",
    ...
    Tabs.ShopTab:AddButton({
        ...
        Description = "",
        Callback = function()
            game:GetService("ReplicatedStorage"):WaitForChild("Rmotes"):WaitForChild("CommF_"):InvokeServer("Ectoplasm", "BuyCheck", 1)
            task.wait()
