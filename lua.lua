...
do
    ...
    MeleeStats = Tabs.StatsT:AddToggle("MeleeStats", {Title = "Melee", Default = false })
    ...
    DefenseStats = Tabs.StatsT:AddToggle("DefenseStats", {Title = "Defense", Default = false })
    ...
    SwordStats = Tabs.StatsT:AddToggle("SwordStats", {Title = "Sword", Default = false })
    ...
    GunStats = Tabs.StatsT:AddToggle("GunStats", {Title = "Gun", Default = false })
    ...
    BloxFruitStats = Tabs.StatsT:AddToggle("BloxFruitStats", {Title = "Blox Fruit", Default = false })
    ...
    BringFruit = Tabs.FruitT:AddToggle("BringFruit", {Title = "Bring Fruit", Default = false })
    ...
    AutoRandomFruit = Tabs.FruitT:AddToggle("AutoRandomFruit", {Title = "Auto Spin Fruit", Default = false })
    ...
    AutoStoreFruit = Tabs.FruitT:AddToggle("AutoStoreFruit", {Title = "Auto Store Fruit", Default = false })
    ...
    AutoDropFruit = Tabs.FruitT:AddToggle("AutoDropFruit", {Title = "Auto Drop Fruit", Default = false })
    ...
    YourRace2 = Tabs.MirageARaceT:AddDropdown("YourRace2", {
        Title = "Select Race",
    ...
    ToggleNoClip = Tabs.PlayerTab:AddToggle("ToggleNoClip", {Title = "NoClip", Default = false })
    ...
    AutoBounty = Tabs.PlayerTab:AddToggle("AutoBounty", {Title = "Auto Bounty", Default = false })

    AutoBounty:OnChanged(function()
        Setting.AutoBounty = Options.AutoBounty.Value
    end)
    AutoBountyHop = Tabs.PlayerTab:AddToggle("AutoBountyHop", {Title = "Auto Bounty Hop", Default = false })
