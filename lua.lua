...
local function TpOfTpTab()
    ...
    elseif New_World then
        ...
        elseif SelectTpSpot == "Value" then
            if InstanceTp then
...
if nearbymon then
    ...
    for i=1,#Enemies do local v = Enemies[i]
        local Human = v:FindFirstChildOfClass("Humanoid")
        if Human and Human.RootPart and Human.Health > 0 and (v.HumanoidRootPart.Position - player.Character.HumanoidRootPart.Position).Magnitude <= 65 then
            ...
            if tostring(args[1]) == "RemoteEvent" then
                if tostring(args[2]) ~= "true" and tostring(args[2]) ~= "false" then
                    if Setting.UseSkill then
                        if (Setting.PosMobMasteryFruit ~= nil and Setting.AutoFarmFruitMastery) or (Setting.AimbotSkillSelectPlayer and Setting.SelectPlayerToAim ~= nil) then
...
do
    ...
    local SelectWeapon = Tabs.AutoFarmTab:AddDropdown("SelectWeapon", {
        Title = "Select Weapon",
    ...
    if Old_World then
        ...
        AutoFarmLevelWithSea22 = Tabs.AutoFarmTab:AddToggle("AutoFarmLevelWithSea22", {Title = "Auto Sea 2 (Normal)", Default = false })
    ...
    task.wait()
    if Old_World then
        local SelectMob = Tabs.AutoFarmTab:AddDropdown("SelectMob", {
            Title = "Select Mob",
    ...
    if Old_World then
        local SelectBoss = Tabs.AutoFarmTab:AddDropdown("SelectBoss", {
            Title = "Select Boss",
    ...
    AutoFarmAllBoss = Tabs.AutoFarmTab:AddToggle("AutoFarmAllBoss", {Title = "Auto Farm All Boss", Default = false })
    ...
    local SelectMaterial = Tabs.AutoFarmTab:AddDropdown("SelectMaterial", {
        Title = "Select Material",
        Values = {"gay"},
        Multi = false,
        Default = 1,
    })
    local AutoMaterial = Tabs.AutoFarmTab:AddToggle("AutoMaterial", {Title = "Auto Farm Selected Material", Default = false })
    ...
    AutoRengoku = Tabs.WeaponTab:AddToggle("AutoRengoku", {Title = "Auto Rengoku", Default = false })
    ...
    local SelectRaidAChip = Tabs.RaidT:AddDropdown("SelectRaidAChip", {
        Title = "Select Raid",
    ...
    Tabs.RaidT:AddButton({
        ...
        Description = "",
        Callback = function()
            game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("RaidsNpc", "Select", tostring(Setting.SelectedRaid))
        end
    })
    local KillAura = Tabs.RaidT:AddToggle("KillAura", {Title = "Kill Aura", Default = false })
    ...
    local DMGAura = Tabs.RaidT:AddToggle("DMGAura", {Title = "Damage Aura", Default = false })

    DMGAura:OnChanged(function()
        Setting.DMGAura = Options.DMGAura.Value
    end)
    local TeleportToNextIsland = Tabs.RaidT:AddToggle("TeleportToNextIsland", {Title = "Teleport To Next Island", Default = false })
    ...
    local SelectRaidAChip2 = Tabs.RaidT:AddDropdown("SelectRaidAChip2", {
        Title = "Select Raid",
        Values = {"Flame","Ice","Quake","Light","Dark","String","Rumble","Magma","Human: Buddha","Sand","Bird: Phoenix"},
        Multi = false,
        Default = 1,
    ...
    local AutoRaid = Tabs.RaidT:AddToggle("AutoRaid", {Title = "Auto Raid", Default = Setting.AutoRaid })
    AutoRaid:OnChanged(function()
        Setting.AutoRaid = Options.AutoRaid.Value
    end)

    Tabs.StatsT:AddSection("Auto Stats")
    local MeleeStats = Tabs.StatsT:AddToggle("MeleeStats", {Title = "Melee", Default = false })
    ...
    local DefenseStats = Tabs.StatsT:AddToggle("DefenseStats", {Title = "Defense", Default = false })
    ...
    local SwordStats = Tabs.StatsT:AddToggle("SwordStats", {Title = "Sword", Default = false })
    ...
    local GunStats = Tabs.StatsT:AddToggle("GunStats", {Title = "Gun", Default = false })
    ...
    local BloxFruitStats = Tabs.StatsT:AddToggle("BloxFruitStats", {Title = "Blox Fruit", Default = false })
    ...
    local BringFruit = Tabs.FruitT:AddToggle("BringFruit", {Title = "Bring Fruit", Default = false })

    BringFruit:OnChanged(function()
        Setting.BringFruit = Options.BringFruit.Value
    end)
    local TeleportFruit = Tabs.FruitT:AddToggle("TeleportFruit", {Title = "Teleport To Fruit", Default = false })

    TeleportFruit:OnChanged(function()
        Setting.TpToFruit = Options.TeleportFruit.Value
    end)
    local AutoRandomFruit = Tabs.FruitT:AddToggle("AutoRandomFruit", {Title = "Auto Spin Fruit", Default = false })
    ...
    local AutoStoreFruit = Tabs.FruitT:AddToggle("AutoStoreFruit", {Title = "Auto Store Fruit", Default = false })
    ...
    local AutoDropFruit = Tabs.FruitT:AddToggle("AutoDropFruit", {Title = "Auto Drop Fruit", Default = false })
    ...
    local SelectDropFruit = Tabs.FruitT:AddDropdown("SelectDropFruit", {
        Title = "Fruit To Drop",
        Values = {"gay"},
        Multi = false,
        Default = 1,
    ...
    local AutoDropSelectFruit = Tabs.FruitT:AddToggle("AutoDropSelectFruit", {Title = "Auto Drop Select Fruit", Default = false })

    AutoDropSelectFruit:OnChanged(function()
        Setting.AutoDropSelectFruit = Options.AutoDropSelectFruit.Value
    end)
    local SelectStoreFruit = Tabs.FruitT:AddDropdown("SelectStoreFruit", {
    ...
    local AutoStoreSelectFruit = Tabs.FruitT:AddToggle("AutoStoreSelectFruit", {Title = "Auto Store Select Fruit", Default = false })
    ...
    local SelectFruitToSnipe = Tabs.FruitT:AddDropdown("SelectFruitToSnipe", {
        Title = "Select Fruit",
        Values = {"gay"},
        Multi = false,
        Default = 1,
    ...
    local AutoSnipeFruit = Tabs.FruitT:AddToggle("AutoSnipeFruit", {Title = "Auto Snipe Fruit", Default = false })

    AutoSnipeFruit:OnChanged(function()
        Setting.AutoSnipeFruit = Options.AutoSnipeFruit.Value
    end)

    Tabs.MirageARaceT:AddSection("Mirage")
    Tabs.MirageARaceT:AddSection("Auto")
    local SelectBoatForMirageIsland = Tabs.MirageARaceT:AddDropdown("SelectBoatForMirageIsland", {
        Title = "Select Boat",
        Values = {"gay"},
        Multi = false,
        Default = 1,
    ...
    local AutoFindMirageIsland = Tabs.MirageARaceT:AddToggle("AutoFindMirageIsland", {Title = "Auto Find Mirage Island", Default = false })
    ...
    local SelectBoatForAutoSpawn = Tabs.MirageARaceT:AddDropdown("SelectBoatForAutoSpawn", {
        Title = "Select Boat",
        Values = {"gay"},
        Multi = false,
        Default = 1,
    ...
    local AutoSpawnBoatMirageTab = Tabs.MirageARaceT:AddToggle("AutoSpawnBoatMirageTab", {Title = "Auto Spawn Ship", Default = false })
    ...
    local YourRace = Tabs.MirageARaceT:AddDropdown("YourRace", {
        Title = "Select Race",
    ...
    local AutoRaceV2 = Tabs.MirageARaceT:AddToggle("AutoRaceV2", {Title = "Auto Evo Race V2", Default = false })

    AutoRaceV2:OnChanged(function()
        Setting.AutoRaceV2 = Options.AutoRaceV2.Value
    end)
    local AutoRaceV3 = Tabs.MirageARaceT:AddToggle("AutoRaceV3", {Title = "Auto Evo Race V3", Default = false })

    AutoRaceV3:OnChanged(function()
        Setting.AutoRaceV3 = Options.AutoRaceV3.Value
    end)
    Tabs.MirageARaceT:AddSection("Race V4")
    local YourRace2 = Tabs.MirageARaceT:AddDropdown("YourRace2", {
        Title = "Select Race",
        Values = {"Mink", "Sky", "Fish", "Human", "Ghoul", "Cyborg"},
        Multi = false,
        Default = 1,
    })
    YourRace2:OnChanged(function(Value)
        Setting.YourRace2 = Value
    end)
    local AutoRaceV4 = Tabs.MirageARaceT:AddToggle("AutoRaceV4", {Title = "Auto Evo Race V4", Default = false })
    ...
    local SelectIgnoreEvent = Tabs.SeaEventT:AddDropdown("SelectIgnoreEvent", {
        Title = "Select Ignore Events",
        Description = "",
        Values = {"gay", "gay2", "gay3"},
        Multi = true,
        Default = {"gay", "gay2"},
    })
    ...
    local SelectSeaLevel = Tabs.SeaEventT:AddDropdown("SelectSeaLevel", {
        Title = "Select Levels",
        Values = {"1", "2", "3", "4", "5", "6"},
        Multi = false,
        Default = 1,
    ...
    local AutoSeaEvent = Tabs.SeaEventT:AddToggle("AutoSeaEvent", {Title = "Auto Sea Events", Default = false })

    AutoSeaEvent:OnChanged(function()
        Setting.AutoSeaEvent = Options.AutoSeaEvent.Value
    end)
    local AutoSeaBeastISeaEvent = Tabs.SeaEventT:AddToggle("AutoSeaBeastISeaEvent", {Title = "Auto Sea Beasts", Default = false })
    ...
    local AutoBuso = Tabs.PlayerTab:AddToggle("AutoBuso", {Title = "Auto Buso", Default = false })

    AutoBuso:OnChanged(function()
        Setting.AutoBuso = Options.AutoBuso.Value
    end)

    local AutoKen = Tabs.PlayerTab:AddToggle("AutoKen", {Title = "Auto Ken", Default = false })
    ...
    local JumpPowerSlider = Tabs.PlayerTab:AddSlider("JumpPowerSlider", {
        Title = "JumpPower",
        Description = "",
        Default = 16,
        Min = 0,
    ...
    local FpsCapSlider = Tabs.PlayerTab:AddSlider("FpsCapSlider", {
        Title = "Fps Cap",
        Description = "",
        Default = 60,
        Min = 0,
    ...
    local ToggleWalkSpeed = Tabs.PlayerTab:AddToggle("ToggleWalkSpeed", {Title = "Enabled/Disabled WalkSpeed", Default = false })

    ToggleWalkSpeed:OnChanged(function()
        Setting.ToggleWalkSpeed = Options.ToggleWalkSpeed.Value
    end)
    local ToggleJumpPower = Tabs.PlayerTab:AddToggle("ToggleJumpPower", {Title = "Enabled/Disabled JumpPower", Default = false })

    ToggleJumpPower:OnChanged(function()
        Setting.ToggleJumpPower = Options.ToggleJumpPower.Value
    end)
    local ToggleFly = Tabs.PlayerTab:AddToggle("ToggleFly", {Title = "Fly", Default = false })

    ToggleFly:OnChanged(function()
        Setting.ToggleFly = Options.ToggleFly.Value
    end)
    local ToggleNoClip = Tabs.PlayerTab:AddToggle("ToggleNoClip", {Title = "NoClip", Default = false })

    ToggleNoClip:OnChanged(function()
        Setting.ToggleNoClip = Options.ToggleNoClip.Value
    end)
    local ToggleFloat = Tabs.PlayerTab:AddToggle("ToggleFloat", {Title = "Float", Default = false })

    ToggleFloat:OnChanged(function()
        Setting.ToggleFloat = Options.ToggleFloat.Value
    end)
    local ToggleDMGAura = Tabs.PlayerTab:AddToggle("ToggleDMGAura", {Title = "DMGAura", Default = false })
    ...
    local SelectPlayerToAim = Tabs.PlayerTab:AddDropdown("SelectPlayerToAim", {
        Title = "Select Player",
        Values = {"rigga56"},
        Multi = false,
        Default = 1,
    ...
    local ToggleAimBotSkill = Tabs.PlayerTab:AddToggle("ToggleAimBotSkill", {Title = "Aimbot Skill", Default = false })

    ToggleAimBotSkill:OnChanged(function()
        Setting.ToggleAimBotSkill = Options.ToggleAimBotSkill.Value
    end)
    local ToggleAimBotGun = Tabs.PlayerTab:AddToggle("ToggleAimBotGun", {Title = "Aimbot Gun", Default = false })

    ToggleAimBotGun:OnChanged(function()
        Setting.ToggleAimBotGun = Options.ToggleAimBotGun.Value
    end)
    Tabs.PlayerTab:AddSection("Bounty")
    local SelectPlayerToAutoBounty = Tabs.PlayerTab:AddDropdown("SelectPlayerToAutoBounty", {
        Title = "Select Player",
        Values = {"rigga56"},
        Multi = false,
        Default = 1,
    ...
    local AutoKillSelectedPlayer = Tabs.PlayerTab:AddToggle("AutoKillSelectedPlayer", {Title = "Auto Kill Selected Player", Default = false })

    AutoKillSelectedPlayer:OnChanged(function()
        Setting.AutoKillSelectedPlayer = Options.AutoKillSelectedPlayer.Value
    end)
    local AutoBounty = Tabs.PlayerTab:AddToggle("AutoBounty", {Title = "Auto Bounty", Default = false })

    AutoBounty:OnChanged(function()
        Setting.AutoBounty = Options.AutoBounty.Value
    end)
    local AutoBountyHop = Tabs.PlayerTab:AddToggle("AutoBountyHop", {Title = "Auto Bounty Hop", Default = false })

    AutoBountyHop:OnChanged(function()
        Setting.AutoBountyHop = Options.AutoBountyHop.Value
    end)
    ...
    local LevelVisual = Tabs.PlayerTab:AddInput("LevelVisual", {
        Title = "Level",
    ...
    local BeliVisual = Tabs.PlayerTab:AddInput("BeliVisual", {
        Title = "Beli",
    ...
    local FragmentVisual = Tabs.PlayerTab:AddInput("FragmentVisual", {
        Title = "Fragment",
    ...
    local StaminaVisual = Tabs.PlayerTab:AddInput("StaminaVisual", {
        Title = "Stamina",
        Default = nil,
        Placeholder = "Placeholder",
        Numeric = false,
    ...
    local HpVisual = Tabs.PlayerTab:AddInput("HpVisual", {
        Title = "HP",
        Default = nil,
        Placeholder = "Placeholder",
        Numeric = false,
    ...
    local SelectUiToHide = Tabs.PlayerTab:AddDropdown("SelectUiToHide", {
        Title = "Select Ui",
        Description = "",
    ...
    local BringMobT = Tabs.Settings:AddToggle("BringMobT", {Title = "Bring Mob", Default = false })

    BringMobT:OnChanged(function()
        Setting.BringMob = Options.BringMobT.Value
    end)
    local CustomQuest = Tabs.Settings:AddToggle("CustomQuest", {Title = "Custom Quest", Default = false })

    CustomQuest:OnChanged(function()
        Setting.CustomQuest = Options.CustomQuest.Value
    end)
    local AutoFarmAuraDistance = Tabs.Settings:AddSlider("AutoFarmAuraDistance", {
    ...
    local AutoFarmLevelPosXX = Tabs.Settings:AddSlider("AutoFarmLevelPosXX", {
        Title = "X",
    ...
    local AutoFarmLevelPosYY = Tabs.Settings:AddSlider("AutoFarmLevelPosYY", {
        Title = "Y",
    ...
    local AutoFarmLevelPosZZ = Tabs.Settings:AddSlider("AutoFarmLevelPosZZ", {
        Title = "Z",
    ...
    local TeleportSpeedAutoFarm = Tabs.Settings:AddSlider("Setting.TeleportSpeedAutoFarm", {
    ...
    local BringMobDistanceSetting = Tabs.Settings:AddSlider("BringMobDistanceSetting", {
        Title = "Distance",
    ...
    local AutoRaidPosX = Tabs.Settings:AddSlider("AutoRaidPosX", {
    ...
    local AutoRaidPosY = Tabs.Settings:AddSlider("AutoRaidPosY", {
    ...
    local AutoRaidPosZ = Tabs.Settings:AddSlider("AutoRaidPosZ", {
    ...
    local TeleportToNEXTIslandSpeed = Tabs.Settings:AddSlider("TeleportToNEXTIslandSpeed", {
    ...
    local AutoNormalChest = Tabs.Settings:AddToggle("AutoNormalChest", {Title = "Normal", Default = false })

    AutoNormalChest:OnChanged(function()
        Setting.AutoNormalChest = Options.AutoNormalChest.Value
    end)
    local AutoDetailChest = Tabs.Settings:AddToggle("AutoDetailChest", {Title = "Detail", Default = false })
    ...
    local VFlySpeedSetting = Tabs.Settings:AddToggle("VFlySpeedSetting", {Title = "Ship Speed", Default = false })

    VFlySpeedSetting:OnChanged(function()
        
    end)
    local PFlySpeedSetting = Tabs.Settings:AddToggle("PFlySpeedSetting", {Title = "Player Speed", Default = false })

    PFlySpeedSetting:OnChanged(function()
        
    end)
    Tabs.Settings:AddSection("Auto Bounty Settings")
    local MaxErrorTrial = Tabs.Settings:AddInput("MaxErrorTrial", {
    ...
    MaxErrorTrial:OnChanged(function()
        print("Input updated:", MaxErrorTrial.Value)
    end)
    Tabs.Settings:AddSection("Stackable")
    local StackableSetting = Tabs.Settings:AddToggle("StackableSetting", {Title = "Stackable", Default = Setting.StackableSetting })
    ...
    local BigSmallWASD = Tabs.Settings:AddToggle("BigSmallWASD", {Title = "Small/Big", Default = false })
    ...
    local HideShowWASD = Tabs.Settings:AddToggle("HideShowWASD", {Title = "Hide/Show", Default = true })
    ...
    local UpDownWASD = Tabs.Settings:AddToggle("UpDownWASD", {Title = "Up/Down", Default = false })
