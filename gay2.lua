...
-- Properties:
a["_TTJY ASSET"]={ZIndexBehavior=Enum.ZIndexBehavior.Sibling,Name="TTJY ASSET",Parent=game:GetService("CoreGui")}a["_TTJY HUB"]={BackgroundColor3=Color3.fromRGB(56.0000042617321,56.0000042617321,56.0000042617321),BackgroundTransparency=0.4000000059604645,BorderColor3=Color3.fromRGB(0,0,0),BorderSizePixel=0,Position=UDim2.new(0.465000004,0,-0.1,0),Size=UDim2.new(0.0700000003,0,0.100000001,0),ZIndex=2,Name="TTJY HUB",Parent=a["_TTJY ASSET"]}a["_UIStroke"]={LineJoinMode=Enum.LineJoinMode.Bevel,Thickness=3,Parent=a["_TTJY HUB"]}a["_UICorner"].Parent=a["_TTJY HUB"]a["_TextButton"]={Font=Enum.Font.SourceSans,Text="TTJY HUB",TextColor3=Color3.fromRGB(0,255,0),TextScaled=true,TextSize=14,TextWrapped=true,BackgroundColor3=Color3.fromRGB(255,255,255),BackgroundTransparency=1,BorderColor3=Color3.fromRGB(0,0,0),BorderSizePixel=0,Size=UDim2.new(1,0,1,0),Parent=a["_TTJY HUB"]}a["_UIStroke1"].LineJoinMode=Enum.LineJoinMode.Bevel;a["_UIStroke1"].Parent=a["_TextButton"]a["_Stop Hop"]={BackgroundColor3=Color3.fromRGB(56.0000042617321,56.0000042617321,56.0000042617321),BackgroundTransparency=0.4000000059604645,BorderColor3=Color3.fromRGB(0,0,0),BorderSizePixel=0,Position=UDim2.new(0.39443019,0,-0.1,0),Size=UDim2.new(0.0700000003,0,0.100000001,0),ZIndex=2,Name="PAUSE Hop",Parent=a["_TTJY ASSET"]}a["_UIStroke2"].LineJoinMode=Enum.LineJoinMode.Bevel;a["_UIStroke2"].Thickness=3;a["_UIStroke2"].Parent=a["_Stop Hop"]a["_UICorner1"].Parent=a["_Stop Hop"]a["_TextButton1"]={Font=Enum.Font.SourceSans,Text="STOP HOP",TextColor3=Color3.fromRGB(255,0,0),TextScaled=true,TextSize=14,TextWrapped=true,BackgroundColor3=Color3.fromRGB(255,255,255),BackgroundTransparency=1,BorderColor3=Color3.fromRGB(0,0,0),BorderSizePixel=0,Size=UDim2.new(1,0,1,0),Parent=a["_Stop Hop"]}a["_UIStroke3"].LineJoinMode=Enum.LineJoinMode.Bevel;a["_UIStroke3"].Parent=a["_TextButton1"]a["_STOP TP"].BackgroundColor3=Color3.fromRGB(56.0000042617321,56.0000042617321,56.0000042617321)a["_STOP TP"].BackgroundTransparency=0.4000000059604645;a["_STOP TP"].BorderColor3=Color3.fromRGB(0,0,0)a["_STOP TP"].BorderSizePixel=0;a["_STOP TP"].Position=UDim2.new(0.534916341,0,-0.1,0)a["_STOP TP"].Size=UDim2.new(0.0700000003,0,0.100000001,0)a["_STOP TP"].ZIndex=2;a["_STOP TP"].Name="STOP TP"a["_STOP TP"].Parent=a["_TTJY ASSET"]a["_UIStroke4"].LineJoinMode=Enum.LineJoinMode.Bevel;a["_UIStroke4"].Thickness=3;a["_UIStroke4"].Parent=a["_STOP TP"]a["_UICorner2"].Parent=a["_STOP TP"]a["_TextButton2"].Font=Enum.Font.SourceSans;a["_TextButton2"].Text="STOP TP"a["_TextButton2"].TextColor3=Color3.fromRGB(255,0,0)a["_TextButton2"].TextScaled=true;a["_TextButton2"].TextSize=14;a["_TextButton2"].TextWrapped=true;a["_TextButton2"].BackgroundColor3=Color3.fromRGB(255,255,255)a["_TextButton2"].BackgroundTransparency=1;a["_TextButton2"].BorderColor3=Color3.fromRGB(0,0,0)a["_TextButton2"].BorderSizePixel=0;a["_TextButton2"].Size=UDim2.new(1,0,1,0)a["_TextButton2"].Parent=a["_STOP TP"]a["_UIStroke5"].LineJoinMode=Enum.LineJoinMode.Bevel;a["_UIStroke5"].Parent=a["_TextButton2"]a["_STATUS"].BackgroundColor3=Color3.fromRGB(56.0000042617321,56.0000042617321,56.0000042617321)a["_STATUS"].BackgroundTransparency=0.4000000059604645;a["_STATUS"].BorderColor3=Color3.fromRGB(0,0,0)a["_STATUS"].BorderSizePixel=0;a["_STATUS"].Position=UDim2.new(0.615287483,0,-0.05,0)a["_STATUS"].Size=UDim2.new(0.0203398019,0,0.0497226082,0)a["_STATUS"].ZIndex=2;a["_STATUS"].Name="STATUS"a["_STATUS"].Parent=a["_TTJY ASSET"]a["_UIStroke6"].LineJoinMode=Enum.LineJoinMode.Bevel;a["_UIStroke6"].Thickness=3;a["_UIStroke6"].Parent=a["_STATUS"]a["_UICorner3"].Parent=a["_STATUS"]a["_ImageButton"].Image="http://www.roblox.com/asset/?id=16586323338"a["_ImageButton"].BackgroundColor3=Color3.fromRGB(255,255,255)a["_ImageButton"].BackgroundTransparency=1;a["_ImageButton"].BorderColor3=Color3.fromRGB(0,0,0)a["_ImageButton"].BorderSizePixel=0;a["_ImageButton"].Size=UDim2.new(1,0,1,0)a["_ImageButton"].Parent=a["_STATUS"];


TTJYHUB = a["_TextButton"]
STOPTP = a["_TextButton2"]
STOPHOP = a["_TextButton1"]
STATUS = a["_ImageButton"]
...
function AutoGetShip()
    if not game.Players.LocalPlayer.Character.Humanoid.Sit and not Setting.WaitBRUH then
        ...
        __U[23]()
        __VE["RlS"].Remotes.CommF_:InvokeServer("BuyBoat", tostring(Setting.SelectShipISeaEvent))
        task.__U[19](0.675)
...
local function StopTeleport()
    STOPTP.TextColor3  = __VE[36](0, 255, 0)
    Setting.BREAKALLTHISSHITHAHAHAHAHA = true
    task.__U[19](0.275)
    STOPTP.TextColor3  = __VE[36](255, 0, 0)
                    ...
                    for _, v in pairs(workspace.Enemies:GetChildren()) do
                        if v and v.Name == tostring(NameMon) and v:FindFirstChild("Humanoid") and v.Humanoid.Health > 0 and (v:FindFirstChild("HumanoidRootPart").Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude < 200 then
                            ...
                            for _, otherMob in pairs(workspace.Enemies:GetChildren()) do
                                if otherMob and otherMob.Name == tostring(NameMon) and otherMob:FindFirstChild("Humanoid") and otherMob.Humanoid.Health > 0 and FirstMob and FirstMob:FindFirstChild("HumanoidRootPart") and (FirstMob:FindFirstChild("HumanoidRootPart").Position - otherMob:FindFirstChild("HumanoidRootPart").Position).Magnitude < __U[31](Setting.BringMobDistance) then
            ...
            if Setting.AutoFarmLevel and not Setting.AutoSea2 then
                __U[6](function()
                    ...
                    if not PlayerGui.Main.Quest.Visible then
                        ...
                        task.__U[19](1)
                        if (CFrameMon.Position - __VE["LPs"].Character.HumanoidRootPart.Position).Magnitude < 3000 then
                    ...
                    repeat
                        for _,v in pairs(workspace.Enemies:GetChildren()) do
                            if v and v.Name == tostring(NameMon) and (CFrameMon.Position - __VE["LPs"].Character.HumanoidRootPart.Position).Magnitude < 3000 then
                                if v:FindFirstChild("Humanoid") and v.Humanoid.Health ~= 0 and Setting.AutoFarmLevel and PlayerGui.Main.Quest.Visible == true and (CFrameMon.Position - __VE["LPs"].Character.HumanoidRootPart.Position).Magnitude < 3000 then
                                    CheckAndClearWeapon()
                                    __U[23]()
                                    Setting.TryNumOfthis1 = 0
                                    repeat
                                        ...
                                        __U[19]()
                                        Setting.TryNumOfthis1 = Setting.TryNumOfthis1 + 1
                                    until v.Humanoid.Health == 0 or PlayerGui.Main.Quest.Visible == false or not Setting.AutoFarmLevel or Setting.TryNumOfthis1 == 300 or (CFrameMon.Position - __VE["LPs"].Character.HumanoidRootPart.Position).Magnitude > 3000
                                end
                            end
                        end
                        tpwithnewtpbyme2(CFrameMon, __U[31](Setting.TeleportSpeedAutoFarm))
                        __U[23]()
                    until PlayerGui.Main.Quest.Visible == false or not Setting.AutoFarmLevel or (CFrameMon.Position - __VE["LPs"].Character.HumanoidRootPart.Position).Magnitude > 3000
                    Attack = false
                    __U[23]()
                end)
                __U[23]()
            elseif Setting.AutoFarmLevel and Setting.AutoSea2 then
                ...
                __U[6](function()
                    ...
                    if Lv >= 700 then
                        ...
                        __U[23]()
                        repeat __U[23]() until __VE["LPs"].Character:FindFirstChild("Humanoid")
                        if not PlayerGui.Main.Quest.Visible and (CFrameMon.Position - __VE["LPs"].Character.HumanoidRootPart.Position).Magnitude < 3000 then
                            tpwithnewtpbyme2(CFrameQ, __U[31](Setting.TeleportSpeedAutoFarm))
                            task.__U[19](1)
                            CommF:InvokeServer("StartQuest", NameQuest, QuestLv)
                            task.__U[19](.175)
                        ...
                        repeat
                            for _,v in pairs(workspace.Enemies:GetChildren()) do
                                if v and v.Name == tostring(NameMon) and (CFrameMon.Position - __VE["LPs"].Character.HumanoidRootPart.Position).Magnitude < 3000 then
                                    if v:FindFirstChild("Humanoid") and v.Humanoid.Health ~= 0 and Setting.AutoFarmLevel and PlayerGui.Main.Quest.Visible and (CFrameMon.Position - __VE["LPs"].Character.HumanoidRootPart.Position).Magnitude < 3000 then
                                        Setting.TryNumOfthis1 = 0
                                        repeat
                                            repeat __U[23]() until __VE["LPs"].Character:FindFirstChild("Humanoid")
                                            MobHumP = v.HumanoidRootPart.Position
        ...
        while __U[23]() do
            if Setting.AutoFarmSelectMob then
                __U[6](function()
                    ...
                    if Setting.CustomQuest and (CFrameMon.Position - __VE["LPs"].Character.HumanoidRootPart.Position).Magnitude < 3000 then
                                ...
                                if v and v.Name == tostring(NameMon) and (CFrameMon.Position - __VE["LPs"].Character.HumanoidRootPart.Position).Magnitude < 3000 then
                                    if v:FindFirstChild("Humanoid") and v.Humanoid.Health ~= 0 and Setting.AutoFarmSelectMob and PlayerGui.Main.Quest.Visible == true then
                                        ...
                                        repeat
                                            ...
                                            __U[19]()
                                            Setting.TryNumOfthis1 = Setting.TryNumOfthis1 + 1
                                        until v.Humanoid.Health == 0 or PlayerGui.Main.Quest.Visible == false or not Setting.AutoFarmSelectMob or Setting.TryNumOfthis1 == 300 or (CFrameMon.Position - __VE["LPs"].Character.HumanoidRootPart.Position).Magnitude > 3000
                                    end
                                end
                            end
                            tpwithnewtpbyme2(CFrameMon, __U[31](Setting.TeleportSpeedAutoFarm))
                            __U[23]()
                        until not PlayerGui.Main.Quest.Visible or not Setting.AutoFarmSelectMob or (CFrameMon.Position - __VE["LPs"].Character.HumanoidRootPart.Position).Magnitude > 3000
                        __U[23]()
                    else
                        tpwithnewtpbyme2(CFrameMon, __U[31](Setting.TeleportSpeedAutoFarm))
                        repeat
                            for _,v in pairs(workspace.Enemies:GetChildren()) do
                                if v and v.Name == tostring(NameMon) and (CFrameMon.Position - __VE["LPs"].Character.HumanoidRootPart.Position).Magnitude < 3000 then
                                    if v:FindFirstChild("Humanoid") and v.Humanoid.Health ~= 0 and Setting.AutoFarmSelectMob and (CFrameMon.Position - __VE["LPs"].Character.HumanoidRootPart.Position).Magnitude < 3000 then
                                        Setting.TryNumOfthis1 = 0
                                        repeat
                                            repeat __U[23]() until __VE["LPs"].Character:FindFirstChild("Humanoid")
                                            MobHumP = v.HumanoidRootPart.Position
                                            ...
                                            __U[19]()
                                            Setting.TryNumOfthis1 = Setting.TryNumOfthis1 + 1
                                        until v.Humanoid.Health == 0 or not Setting.AutoFarmSelectMob or Setting.TryNumOfthis1 == 300 or (CFrameMon.Position - __VE["LPs"].Character.HumanoidRootPart.Position).Magnitude > 3000
                                    end
                                end
                            end
                            tpwithnewtpbyme2(CFrameMon, __U[31](Setting.TeleportSpeedAutoFarm))
                            __U[23]()
                        until not Setting.AutoFarmSelectMob or Setting.CustomQuest or (CFrameMon.Position - __VE["LPs"].Character.HumanoidRootPart.Position).Magnitude > 3000
                        __U[23]()
                    end
                end)
                __U[23]()
				...
				if Setting.CustomQuest then
					if Setting.SelectBoss == "The Saw" or Setting.SelectBoss == "Greybeard" or Setting.SelectBoss == "Saber Expert" then
						if workspace.Enemies:FindFirstChild(tostring(Setting.SelectBoss)) then
							tpwithnewtpbyme2(CFrameBoss, __U[31](Setting.TeleportSpeedAutoFarm))
							__U[23]()
							for _, v in pairs(workspace.Enemies:GetChildren()) do
								if v and v.Name == tostring(NameBoss) then
									if v:FindFirstChild("Humanoid") and v.Humanoid.Health ~= 0 and Setting.AutoFarmSelectBoss and (CFrameBoss.Position - __VE["LPs"].Character.HumanoidRootPart.Position).Magnitude < 3000 and not Setting.AutoFarmAllBoss then
										Setting.TryNumOfthis1 = 0
										repeat
											repeat __U[23]() until __VE["LPs"].Character:FindFirstChild("Humanoid")
											MobHumP = v.HumanoidRootPart.Position
											...
											__U[19]()
											Setting.TryNumOfthis1 = Setting.TryNumOfthis1 + 1
										until v.Humanoid.Health == 0 or not Setting.AutoFarmSelectBoss or Setting.TryNumOfthis1 == 300 or (CFrameBoss.Position - __VE["LPs"].Character.HumanoidRootPart.Position).Magnitude > 3000 or Setting.AutoFarmAllBoss
									end
								end
							end
							task.__U[19](0.675)
						...
						if not PlayerGui.Main.Quest.Visible then
							tpwithnewtpbyme2(CFrameQBoss, __U[31](Setting.TeleportSpeedAutoFarm))
							task.__U[19](1)
							if (CFrameBoss.Position - __VE["LPs"].Character.HumanoidRootPart.Position).Magnitude < 3000 then
								...
								if v and v.Name == tostring(NameBoss) then
									if v:FindFirstChild("Humanoid") and v.Humanoid.Health ~= 0 and Setting.AutoFarmSelectBoss and (CFrameBoss.Position - __VE["LPs"].Character.HumanoidRootPart.Position).Magnitude < 3000 and not Setting.AutoFarmAllBoss then
										...
										repeat
											...
											__U[19]()
											Setting.TryNumOfthis1 = Setting.TryNumOfthis1 + 1
										until v.Humanoid.Health == 0 or not Setting.AutoFarmSelectBoss or Setting.TryNumOfthis1 == 300 or (CFrameBoss.Position - __VE["LPs"].Character.HumanoidRootPart.Position).Magnitude > 3000 or Setting.AutoFarmAllBoss or not PlayerGui.Main.Quest.Visible
									end
								end
							end
							task.__U[19](0.675)
					...
					if Setting.CustomQuest then
						for _, v in pairs(workspace.Enemies:GetChildren()) do
							if v and table.find(AllBossNameSea1, tostring(v.Name)) then
								...
								if v:FindFirstChild("Humanoid") and v.Humanoid.Health ~= 0 and Setting.AutoFarmAllBoss and (CFrameBoss.Position - __VE["LPs"].Character.HumanoidRootPart.Position).Magnitude < 3000 and not Setting.AutoFarmSelectBoss then
									Setting.TryNumOfthis1 = 0
									repeat
										repeat __U[23]() until __VE["LPs"].Character:FindFirstChild("Humanoid")
										MobHumP = v.HumanoidRootPart.Position
										...
										__U[19]()
										Setting.TryNumOfthis1 = Setting.TryNumOfthis1 + 1
									until v.Humanoid.Health == 0 or not Setting.AutoFarmAllBoss or Setting.TryNumOfthis1 == 300 or(CFrameBoss.Position - __VE["LPs"].Character.HumanoidRootPart.Position).Magnitude > 3000 or Setting.AutoFarmSelectBoss or not PlayerGui.Main.Quest.Visible
								end
							end
						end
						__U[23]()
            ...
            if not game:GetService("Players").LocalPlayer.Data.Race:FindFirstChild("Evolved") then
                if __VE["RlS"].Remotes.CommF_:InvokeServer("Alchemist","1") == 0 then
                    ...
                    if (__U[57](-2779.83521, 72.9661407, -3574.02002) - game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= 4 then
                        task.__U[19](1.3)
                        __VE["RlS"].Remotes.CommF_:InvokeServer("Alchemist","2")
                    end
                elseif __VE["RlS"].Remotes.CommF_:InvokeServer("Alchemist","1") == 1 then
                    __U[6](function()
                ...
                elseif __VE["RlS"].Remotes.CommF_:InvokeServer("Alchemist","1") == 2 then
                    if game:GetService("Players").LocalPlayer.Data.Beli.Value >= 500000 then
                        __VE["RlS"].Remotes.CommF_:InvokeServer("Alchemist","3")
                    else
			...
			if Setting.AutoFarmFruitMastery then
                __U[6](function()
					...
					repeat
						for _,v in pairs(workspace.Enemies:GetChildren()) do
							if v and v.Name == tostring(NameMon) and (CFrameMon.Position - __VE["LPs"].Character.HumanoidRootPart.Position).Magnitude < 3000 then
								if v:FindFirstChild("Humanoid") and v.Humanoid.Health ~= 0 and Setting.AutoFarmFruitMastery and (CFrameMon.Position - __VE["LPs"].Character.HumanoidRootPart.Position).Magnitude < 3000 then
									CheckAndClearWeapon()
									__U[23]()
									Setting.TryNumOfthis1 = 0
									repeat
						...
						tpwithnewtpbyme2(CFrameMon, __U[31](Setting.TeleportSpeedAutoFarm))
						__U[23]()
					until not Setting.AutoFarmFruitMastery or (CFrameMon.Position - __VE["LPs"].Character.HumanoidRootPart.Position).Magnitude > 3000
                    Setting.UseSkill = false
                    Setting.PauseAutoEqu = false
                end)
			end
			...
			if Setting.AutoFarmGunMastery then
                __U[6](function()
					...
					repeat
						for _,v in pairs(workspace.Enemies:GetChildren()) do
							if v and v.Name == tostring(NameMon) and (CFrameMon.Position - __VE["LPs"].Character.HumanoidRootPart.Position).Magnitude < 3000 then
								if v:FindFirstChild("Humanoid") and v.Humanoid.Health ~= 0 and Setting.AutoFarmGunMastery and (CFrameMon.Position - __VE["LPs"].Character.HumanoidRootPart.Position).Magnitude < 3000 then
									CheckAndClearWeapon()
									__U[23]()
									Setting.TryNumOfthis1 = 0
									repeat
										...
										if v.Humanoid.Health >= HealthMs then
											...
											tpwithnewtpbyme(MobHumP.X + Setting.AutoFarmPosX, MobHumP.Y + Setting.AutoFarmPosY, MobHumP.Z + Setting.AutoFarmPosZ, __U[31](Setting.TeleportSpeedAutoFarm))
                                            __U[23]()
                                            game:GetService("Players").LocalPlayer.Character[tostring(__VE["LPs"].Character:FindFirstChildWhichIsA("Tool"))].RemoteFunctionShoot:InvokeServer(MobHumP)
                                            __U[23]()
										end
									until v.Humanoid.Health == 0 or not Setting.AutoFarmGunMastery or (CFrameMon.Position - __VE["LPs"].Character.HumanoidRootPart.Position).Magnitude > 3000
								end
							end
						end
						tpwithnewtpbyme2(CFrameMon, __U[31](Setting.TeleportSpeedAutoFarm))
						__U[23]()
                        Setting.PauseAutoEqu = false
					until not Setting.AutoFarmGunMastery or (CFrameMon.Position - __VE["LPs"].Character.HumanoidRootPart.Position).Magnitude > 3000
                    Setting.PauseAutoEqu = false
                end)
			end
		end
    ...
    __U[58](function()
        while __U[23]() do
            if Setting.AutoSeaEvent then
                ...
                if game.Players.LocalPlayer.Character.Humanoid.Sit then
                    repeat __U[23]() until (not game.Players.LocalPlayer.Character:FindFirstChild("Humanoid") or (__VE["LPs"].Character:FindFirstChild("Humanoid") and __VE["LPs"].Character.Humanoid.Health == 0) or (game.Players.LocalPlayer.Character:FindFirstChild("Humanoid") and not game.Players.LocalPlayer.Character.Humanoid.Sit and not Setting.WaitBRUH)) or not Setting.AutoSeaEvent
                end
...
do
    ...
    BigSmallWASD:OnChanged(function()
        if Options.BigSmallWASD.Value then
            game.__VE["CG"]["InputPcToMobile"].W.Size = UDim2.new(0.1, 0, 0.1, 0)
            game.__VE["CG"]["InputPcToMobile"].A.Size = UDim2.new(0.1, 0, 0.1, 0)
            game.__VE["CG"]["InputPcToMobile"].S.Size = UDim2.new(0.1, 0, 0.1, 0)
            game.__VE["CG"]["InputPcToMobile"].D.Size = UDim2.new(0.1, 0, 0.1, 0)
        else
            game.__VE["CG"]["InputPcToMobile"].W.Size = UDim2.new(0.05, 0, 0.05, 0)
            game.__VE["CG"]["InputPcToMobile"].A.Size = UDim2.new(0.05, 0, 0.05, 0)
            game.__VE["CG"]["InputPcToMobile"].S.Size = UDim2.new(0.05, 0, 0.05, 0)
            game.__VE["CG"]["InputPcToMobile"].D.Size = UDim2.new(0.05, 0, 0.05, 0)
        end
    end)
    ...
    HideShowWASD:OnChanged(function()
        if Options.HideShowWASD.Value then
            game.__VE["CG"]["InputPcToMobile"].W.Visible = true
            game.__VE["CG"]["InputPcToMobile"].A.Visible = true
            game.__VE["CG"]["InputPcToMobile"].S.Visible = true
            game.__VE["CG"]["InputPcToMobile"].D.Visible = true
        else
            game.__VE["CG"]["InputPcToMobile"].W.Visible = false
            game.__VE["CG"]["InputPcToMobile"].A.Visible = false
            game.__VE["CG"]["InputPcToMobile"].S.Visible = false
            game.__VE["CG"]["InputPcToMobile"].D.Visible = false
        end
    end)
    ...
    UpDownWASD:OnChanged(function()
        if Options.UpDownWASD.Value then
            game.__VE["CG"]["InputPcToMobile"].W.Position = UDim2.new(0.05, 0, 0.7, 0)
            game.__VE["CG"]["InputPcToMobile"].A.Position = UDim2.new(0, 0, 0.8, 0)
            game.__VE["CG"]["InputPcToMobile"].S.Position = UDim2.new(0.05, 0, 0.9, 0)
            game.__VE["CG"]["InputPcToMobile"].D.Position = UDim2.new(0.1, 0, 0.8, 0)
        else
            game.__VE["CG"]["InputPcToMobile"].W.Position = UDim2.new(0.05, 0, 0.1, 0)
            game.__VE["CG"]["InputPcToMobile"].A.Position = UDim2.new(0, 0, 0.2, 0)
            game.__VE["CG"]["InputPcToMobile"].S.Position = UDim2.new(0.05, 0, 0.3, 0)
            game.__VE["CG"]["InputPcToMobile"].D.Position = UDim2.new(0.1, 0, 0.2, 0)
        end
    end)
end
